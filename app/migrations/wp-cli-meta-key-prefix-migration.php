...
if( defined('WP_CLI') && WP_CLI ) {
	...
	class metakeyPrefixMigrationCommand {
		 ...
		 * @when after_wp_load
		 */
		public function __invoque( $args, $assoc_args ) {
			global $wpdb;
			...
			WP_CLI::success( 
				sprintf(
					"Old metakeys updated for the new one. Nothing else to do.", 
					(int) $updated, 
					$old_metakey, 
					$new_metakey, 
					count($post_ids) 
	...
	WP_CLI::addCommand('pantheon-content-publisher metakey-prefix-migration', 'metakeyPrefixMigrationCommand')
}
?>